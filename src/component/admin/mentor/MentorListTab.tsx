...
interface Mentor {
    ...
    // Skills will be loaded from mentor_skill_relations
    skills?: MentorSkill[];
}
...
interface MentorFormData {
    ...
    headline: string;
    description: string;
    selected_skills: string[]; // Array of skill IDs
    published: boolean;
...
const MentorListTab: React.FC<MentorListTabProps> = ({ loading, setLoading }) => {
    // State management
    ...
    const saveMentor = async () => {
        try {
            ...
            if (formData.selected_skills.length > 0) {
                const skillRelations = formData.selected_skills.map(skillId => ({
                    mentor_id: mentorId,
                    skill_id: skillId
                }));
    ...
    // Add new experience/education/activity functions
                        ...
                        <div className="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500 mt-1">
                                    Chọn các kỹ năng phù hợp với mentor này
                                </p>
                            </div>
